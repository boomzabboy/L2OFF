...
public:
	...
	static int __cdecl AssemblePartyMember1(char *buffer, int maxSize, const char *format, UINT32 a, const wchar_t *b, UINT32 c, UINT32 d, UINT32 e, UINT32 f, UINT32 g, UINT32 h, UINT32 i, UINT32 j, UINT32 k, UINT32 l);
	static int __cdecl AssemblePartyMember2(char *buffer, int maxSize, const char *format, UINT32 a);
