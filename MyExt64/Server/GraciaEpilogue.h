...
public:
	...
	static INT32 __cdecl SendSummonInfoHelper1(class CSharedCreatureData *sd);
	static INT32 __cdecl SendSummonInfoHelper2(class CSharedCreatureData *sd);
	...
	static bool IsEconomySell(void *economy);
	static bool IsEconomyBuy(void *economy);
